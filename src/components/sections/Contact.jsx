...
const socialLinks = [
  {
    name: "Email",
    url: "mailto:tin.lucic172@gmail.com",
    icon: (
      <svg
  ...
  {
    name: "GitHub",
    url: "https://github.com/d0ughb0yy",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/tin-lučić-367953266/",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        ...
        <div className="flex justify-center gap-6">
          {socialLinks.map((link) => (
            <motion.a
              ...
              className="p-4 bg-bg-card rounded-xl border border-border hover:border-primary/50 text-text-muted hover:text-primary transition-all duration-300"
