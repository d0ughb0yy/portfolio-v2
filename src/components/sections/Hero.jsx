    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-linear-to-br from-bg via-bg to-bg-card animate-gradient">
      ...
      >
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold mb-4 bg-linear-to-r from-text via-primary to-accent bg-clip-text text-transparent"
        >
          Tin Lučić
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-lg text-text-muted/80 mb-4"
        >
          Pula, Croatia
        </motion.p>
        ...
        <motion.p
          ...
          className="text-base text-text-muted/80 max-w-2xl mx-auto mb-6"
        >
