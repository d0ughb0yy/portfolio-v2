  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-bg-card/80 backdrop-blur-xl rounded-2xl p-6 border border-border/50 hover:border-primary/70 hover:shadow-[0_0_20px_rgba(56,189,248,0.3)] w-full"
      >
